      ...
      <div className={`linkWrapper ${css.linkWrapper}`}>
        <a href="">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10.36 19.26">
            <defs></defs>
            <title>facebookIconEdited</title>
            <g id="Layer_2" data-name="Layer 2">
              <g id="Layer_1-2" data-name="Layer 1">
                <path
                  class="cls-1"
                  d="M6.84,5.11V7.36h3.33l-.53,3.47H6.84v8.38H3.09V10.83h-3V7.36h3V4.72c0-3,1.8-4.67,4.54-4.67a18.71,18.71,0,0,1,2.68.23v3H8.8A1.74,1.74,0,0,0,6.84,5.11Z"
                />
              </g>
            </g>
          </svg>
